...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 26, 2024 lúc 08:21 AM
...
(1, 'BSCKII. TRẦN ĐĂNG KHOA', 'Asus', 20000000, 'bs-Khoa-4x6-1-433x650.jpg', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay!', 24, 'Asus'),
(2, 'THẠC SĨ, BS LÊ THỊ THU HÀ', 'Razer', 52130000, 'BS-HA-KHOA-DD.png', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay! Mua ngay với mức giá đầy ưu đãi!\r\n', 24, 'Razer'),
(3, 'BSCKII ĐỖ HỮU LƯƠNG', 'Acer', 20500000, 'CNK_YHTT.jpg', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay! Mua ngay với mức giá đầy ưu đãi!\r\n', 24, 'Acer'),
(4, 'BSCKII TRƯƠNG MINH THƯƠNG', 'Msi', 21490000, 'CNK_c8.jpg', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay! Mua ngay với mức giá đầy ưu đãi!\r\n', 24, 'Msi'),
(5, 'BSCKII. THÂN HỒNG ANH', 'Asus', 12999000, 'BS-Than-Hong-Anh-433x650.jpg', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay! Mua ngay với mức giá đầy ưu đãi!\r\n', 24, 'Asus'),
(6, 'BSCKI. NG.THỊ HUYỀN TRANG', 'Msi', 20390000, 'NguyenThiHuyenTrang.jpg', 'Sản phẩm với cấu hình mạnh mẽ, với con chip cân tất cả mọi tựa game hiện nay! Mua ngay với mức giá đầy ưu đãi!\r\n', 24, 'Msi');
